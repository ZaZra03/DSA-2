...
/**
 * The Main class contains the main method for the UnionFind program. It
 * handles user input for adding nodes to a set and performing Union and Find
 * operations on the set using the UnionFind class.
 * 
 * @class Main
 * 
...
public class Main {
     ...
     * handles user input to perform Union and Find operations on the set using
     * the UnionFind class.
     * 
