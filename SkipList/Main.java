...
public class Main {
			...
			try {
				...
				case 7: // Search from Head
					if (skiplist.getHead() != null) {
						...
						searchFromHead(list, currentSkipNode, isFound, nodesToSkip, value, numNodes, numSkipNodes);
					} else
				...
				case 8: // Search from Tail
					if (skiplist.getHead() != null) {
						...
						searchFromTail(list, currentSkipNode, isFound, nodesToSkip, value, numNodes, numSkipNodes);
					} else
						System.out.println("Skip List is empty.");
					break;
	 ...
	 */
	static void searchFromHead(LinkedList list, SkipNode currentSkipNode, boolean isFound, int nodesToSkip, int value,
			int numNodes, int numSkipNodes) {
	 ...
	 * @param numSkipNodes    the number of SkipNodes traversed during the search
	 */
	static void searchFromTail(LinkedList list, SkipNode currentSkipNode, boolean isFound, int nodesToSkip, int value,
			int numNodes, int numSkipNodes) {
